...
const Dashboard: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const params = branch ? { branchId: branch.id } : {};
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-100 min-h-screen">
      {/* Branch Selector for Admin Users - COMMENTED OUT */}
      {/* <BranchSelector
      ...
      <DownloadReport selectedBranchId={null} />

      {/* Recent Transactions & Sales Chart */}
      <div className="mb-6 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        <div className="col-span-1 sm:col-span-2">
          <SalesChart selectedBranchId={null} />
        </div>
        <div className="col-span-1">
          <RecentTransactions selectedBranchId={null} />
        </div>
      </div>
